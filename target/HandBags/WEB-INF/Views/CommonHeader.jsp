...
<!--  <script src="Resources/js/pswrdcheck.js"  type="text/javascript"></script>-->
<style>
...
<nav class="navbar navbar-default">
  <div class="container-fluid" style="background-color:#00FFFF;">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">NuLookWoman.com</a> 
    </div>
    ...
    <a class="menu" href="AdminLogin">Admin Login</a>
    </div>
